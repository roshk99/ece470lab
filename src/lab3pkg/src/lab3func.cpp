...
//Uncomment these when you have enter the correct value in each Question mark.
	cout<<	DH2HT(0.0, -PI/2, 0.152, theta1)*
			DH2HT(0.244, 0, 0.120, theta2)*
			DH2HT(0.213, 0, -0.093, theta3)*
			DH2HT(0.0, -PI/2, 0.083, theta4)*
			DH2HT(0.0, PI/2, 0.083, theta5)*
			DH2HT(0.0535, PI, (0.082+0.056), theta6)<<endl;
